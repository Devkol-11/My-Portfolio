...
const stats = [
    {
        ...
        hoverClass: 'hover:bg-accent active:bg-accent',
        hoverText: 'hover:text-on-accent active:text-on-accent',
    },
    {
        value: '10+',
        label: 'products shipped end-to-end.',
        sub: 'Projects delivered',
        hoverClass: 'hover:bg-accent-red active:bg-accent-red hover:text-white active:text-white',
        hoverText: '',
    },
    {
        value: '5+',
        ...
        hoverClass: 'hover:bg-accent-blue active:bg-accent-blue hover:text-white active:text-white',
        hoverText: '',
    },
    {
        value: '∞',
        ...
        sub: 'Fuel consumed',
        hoverClass: 'hover:bg-green active:bg-green',
        hoverText: 'hover:text-on-green active:text-on-green',
    },
];
